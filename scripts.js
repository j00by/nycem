$(document).ready(function() {
  ...
  $('#btnClimateGentrification').click(function() {
      updateContent(
          $(this), 
          'Climate Gentrification', // Title for the content
          'Climate Gentrification refers to the phenomenon where neighborhoods less susceptible to climate change impacts become more desirable, leading to increased property values and the displacement of lower-income residents. This process is significant because it underscores the intersection of climate resilience and social inequality. <br><br> In New York City, this is observed in areas like the Brooklyn waterfront, where post-industrial neighborhoods perceived as safer from sea-level rise have seen a surge in development. This has led to the displacement of long-standing, lower-income communities, highlighting the need for inclusive urban planning.', // Content
          'path/to/climate_gentrification_image.jpg', // Image path
          'Climate Gentrification Image' // Image alt text
      );
  });
